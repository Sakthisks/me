        ...
        <div>
          ...
          <aside id="colorlib-aside" className="border js-fullheight"style={{backgroundColor: '#0B192F'}}>
            <div className="text-center">
              ...
              <span className="email"><i className="icon-mail"></i> <a  target="_blank" rel="noopener noreferrer" href= 'https://mail.google.com/mail/u/0/?view=cm&fs=1&tf=1&source=mailto&to=sakthikarthigiselvi@gmail.com'>sakthikarthigaiselvi.sekar@gmail.com</a></span>
            </div>
